...
<template>
  <div class="relative border rounded-t-lg w-full overflow-auto lg:max-h-[calc(100vh-252px)]">
  ...
  >
    ...
    <div class="flex items-center space-x-2">
      ...
      >
        <SelectTrigger id="pageSize-select" class="h-8 w-[70px] border rounded-md text-sm bg-white">
      ...
      <span> {{ t('dan') || 'dan' }} {{ props.pagination.totalCount }} </span>
    </div>
