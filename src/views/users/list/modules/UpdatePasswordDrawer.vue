...
import { useUpdatePassword } from '../query/useUpdatePassword'
...
const onSubmit = handleSubmit((formValues) => {
  const userId = props.employee?.user_id || props.employee?.userId || props.employee?.id

  if (!userId) {
    toast.error(t('error-occurred', 'User ID is missing'))
    return
  }
