  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: { uz: "Rol bo'yicha:\n• Viloyat hokimi — viloyat tanlash majburiy\n• Tuman hokimi — viloyat va tuman tanlash majburiy\n• Direktor va O'qituvchi — viloyat + tuman majburiy, maktab ixtiyoriy\n• Admin — hech narsa tanlash shart emas", uzc: "Рол бўйича: Вилоят ҳокими — вилоят мажбурий; Туман ҳокими — вилоят ва туман мажбурий; Директор/Ўқитувчи — вилоят+туман мажбурий, мактаб ихтиёрий; Админ — ҳеч нарса мажбурий эмас.", ru: "По роли: Областной хоким — обязательно выбрать область; Районный — область и район обязательны; Директор/Учитель — область+район обязательны, школа необязательна; Администратор — ничего не обязательно.", en: "By role: Regional Governor — region required; District Governor — region + district required; Director/Teacher — region + district required, school optional; Admin — nothing required." }
      }
    ]
  },
  {
